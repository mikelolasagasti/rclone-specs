...
%if %{with check}
%check
for test in "TestMixed" "TestMetadata" "TestMediaReceiverRegistrarService" "TestAccountWriteToWithBuffer" "TestLocal" "TestRemoteGzip" "TestIntegration" "TestPolicy3"\
; do
